...
model = dict(
    ...
    to_float32=True,
    labels_or_label_file='../../data_preprocessed_full/label.txt',
...
train_pipeline = [
    ...
    dict(
        type='DenseSampleFrames', clip_len=8, frame_interval=1, num_clips=num_segs),
...
log_level = 'INFO'
load_from = "/mlcv/WorkingSpace/Personals/tuongbck/VNDH/mmaction2/pretrain_model/actionclip_vit-base-p16-res224-clip-pre_g8xb16_1x1x8_k400-rgb_20230801-b307a0cd.pth"
resume = False
