...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        blending=dict(
            ...
            augments=[
                dict(type='MixupBlending', alpha=0.8, num_classes=6),
                dict(type='CutmixBlending', alpha=1, num_classes=6)
            ]),
        format_shape='NCTHW'),
)
...
train_pipeline = [
    ...
    dict(type='DenseSampleFrames', clip_len=12, frame_interval=1, num_clips=1),
...
load_from = "/mlcv/WorkingSpace/Personals/tuongbck/VNDH/mmaction2/train_mvit/best_acc_top1_epoch_1.pth"
