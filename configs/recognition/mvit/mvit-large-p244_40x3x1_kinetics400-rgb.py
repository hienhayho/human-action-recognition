...
train_pipeline = [
    ...
    dict(type='SampleFrames', clip_len=3, frame_interval=1, num_clips=2),
...
load_from = "https://download.openmmlab.com/mmaction/v1.0/recognition/mvit/converted/mvit-large-p244_40x3x1_kinetics400-rgb_20221021-11fe1f97.pth"